...
const ListingStep2 = ({ formData, cityData, loading, handleInputChange, error, handleFormData }) => {
    const [searchArea, setSearchArea] = useState('');
    const filteredAreas = cityData.areas.filter(area =>
