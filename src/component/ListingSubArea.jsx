...
//                 <h2 className="text-3xl font-bold text-gray-900 mb-2">Choose your sub area</h2>
...
//                                     onClick={() => handleInputChange('subArea', subArea.u_sub_area_name_id)}
