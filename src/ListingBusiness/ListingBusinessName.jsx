          ...
          <div className="flex items-center justify-between mb-4">
            ...
            <label className="flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={isDualShift}
                onChange={(e) => setIsDualShift(e.target.checked)}
                className="w-4 h-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500"
              />
              <span className="ml-2 text-sm text-gray-700">Dual Shift</span>
            </label>
          </div>

          {/* Single Shift */}
          {!isDualShift && <SingleShift timeOptions={timeOptions} />}

          {/* Dual Shift */}
          {isDualShift && <DualShift timeOptions={timeOptions} />}
        </div>
